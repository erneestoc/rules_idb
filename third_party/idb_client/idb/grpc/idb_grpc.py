...
class CompanionServiceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def dap(self, stream: 'grpclib.server.Stream[idb_pb2.DapRequest, idb_pb2.DapResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def send_notification(self, stream: 'grpclib.server.Stream[idb_pb2.SendNotificationRequest, idb_pb2.SendNotificationResponse]') -> None:
        pass

    @abc.abstractmethod
    async def simulate_memory_warning(self, stream: 'grpclib.server.Stream[idb_pb2.SimulateMemoryWarningRequest, idb_pb2.SimulateMemoryWarningResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def revoke(self, stream: 'grpclib.server.Stream[idb_pb2.RevokeRequest, idb_pb2.RevokeResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def contacts_clear(self, stream: 'grpclib.server.Stream[idb_pb2.ContactsClearRequest, idb_pb2.ContactsClearResponse]') -> None:
        pass

    @abc.abstractmethod
    async def photos_clear(self, stream: 'grpclib.server.Stream[idb_pb2.PhotosClearRequest, idb_pb2.PhotosClearResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def repl(self, stream: 'grpclib.server.Stream[idb_pb2.ReplRequest, idb_pb2.ReplResponse]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def tail(self, stream: 'grpclib.server.Stream[idb_pb2.TailRequest, idb_pb2.TailResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/idb.CompanionService/send_notification': grpclib.const.Handler(
                ...
                grpclib.const.Cardinality.UNARY_UNARY,
                idb_pb2.SendNotificationRequest,
                idb_pb2.SendNotificationResponse,
            ),
            '/idb.CompanionService/simulate_memory_warning': grpclib.const.Handler(
                self.simulate_memory_warning,
                grpclib.const.Cardinality.UNARY_UNARY,
                idb_pb2.SimulateMemoryWarningRequest,
                idb_pb2.SimulateMemoryWarningResponse,
            ),
            ...
            '/idb.CompanionService/revoke': grpclib.const.Handler(
                self.revoke,
                grpclib.const.Cardinality.UNARY_UNARY,
                idb_pb2.RevokeRequest,
                idb_pb2.RevokeResponse,
            ),
            ...
            '/idb.CompanionService/contacts_clear': grpclib.const.Handler(
                self.contacts_clear,
                grpclib.const.Cardinality.UNARY_UNARY,
                idb_pb2.ContactsClearRequest,
                idb_pb2.ContactsClearResponse,
            ),
            '/idb.CompanionService/photos_clear': grpclib.const.Handler(
                self.photos_clear,
                grpclib.const.Cardinality.UNARY_UNARY,
                idb_pb2.PhotosClearRequest,
                idb_pb2.PhotosClearResponse,
            ),
